import type { AgentTypingClientEvent, AudioEventAlignment, ClientToolCallClientEvent, McpToolCallClientEvent, McpConnectionStatusClientEvent, AgentToolRequestClientEvent, AgentToolResponseClientEvent, AgentToolResponseFullPayloadClientEvent, ConversationMetadata, AsrInitiationMetadataEvent, Interruption, AgentResponseCorrection, AgentChatResponsePartClientEvent, Ping } from "@elevenlabs/types";
/**
 ...
 */
export declare const CALLBACK_KEYS: readonly ["onConnect", "onDisconnect", "onError", "onMessage", "onAudio", "onModeChange", "onStatusChange", "onCanSendFeedbackChange", "onUnhandledClientToolCall", "onVadScore", "onMCPToolCall", "onMCPConnectionStatus", "onAgentToolRequest", "onAgentToolResponse", "onConversationMetadata", "onAsrInitiationMetadata", "onInterruption", "onAgentResponseCorrection", "onAgentChatResponsePart", "onAudioAlignment", "onGuardrailTriggered", "onAgentTyping", "onExternalAgentConnected", "onPing", "onDebug"];
